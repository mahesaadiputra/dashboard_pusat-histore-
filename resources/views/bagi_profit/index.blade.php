    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">atur harga jual</h1>
                    </div>
                    ...
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">atur harga jual</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>jenis bintang</th>
                                            <th>persen dari  Hpp</th>
                                            @role('admin') <th>action</th>@endrole
                                            
                                        </tr>
                                    </thead>
                                    <tbody>
                                          @php $no = ($bagi_profit->currentpage()-1)* $bagi_profit->perpage() + 1; @endphp
                                        @forelse ($bagi_profit as $row)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>{{$row->jenis_bintang}}</td>
                                            <td>{{$row->profit}}%</td>
                                         @role('admin')   <td> 
                                               <a href="{{ route('atur_hargajual.edit', $row->id) }}" 
