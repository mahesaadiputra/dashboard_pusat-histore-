    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manajemen vendor</h1>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-md-4">
                        @card
                            ...
                            <form role="form" action="{{ route('vendor.store') }}" method="POST">
                                ...
                                @endrole
                                <div class="form-group">
                                    <label for="sub_nama">nama vendor</label>
                                    <input type="text" 
                                    name="nama"
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" 
                                    name="alamat"
                                    class="form-control {{ $errors->has('alamat') ? 'is-invalid':'' }}" id="alamat" required>
                                </div>
                        ...
                        @card
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                           @php $no = ($vendor->currentpage()-1)* $vendor->perpage() + 1; @endphp
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    ...
                                                    <input type="hidden" name="_method" value="DELETE">
                                                     @role('admin')
                                                 <button class="btn btn-info" data-mytitle="{{$row->nama}}" data-alamat="{{$row->alamat}}" data-catid={{$row->id}} data-toggle="modal" data-target="#edit">
