...
@section('title')
    <title>Manajemen pre order</title>
    <head>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manajemen pre order</h1>
                    </div>
                    <div class="col-sm-6">
                        ...
                        @card
                            ...
                            <form role="form" action="{{ route('preorder.store') }}" method="POST">
                                ...
                                <select class="form-control"  name="alamat">
                                  <option value="">pilih</option>
                                  @foreach($user as $row)
                                  <option value="{{$row['alamat']}}">{{$row['alamat']}} status: {{$row['role']}}</option>
                                  @endforeach
                                </select> 
                                </div>
                        ...
                        @card
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                           @php $no = ($pre_order->currentpage()-1)* $pre_order->perpage() + 1; @endphp
                                        @forelse ($pre_order as $row)
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>{{ $row->vendor }}</td>
