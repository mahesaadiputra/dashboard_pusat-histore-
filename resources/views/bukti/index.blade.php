    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Manajemen Topup</h1>
                    </div>
                    <div class="col-sm-6">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if (!empty($row->photo))
                                                    <img src="{{ asset('../historeadm/uploads/bukti/' . $row->photo) }}" 
                                                        alt="{{ $row->invoice }}" width="50px" height="50px">
                                                @else
                                                    <img src="http://via.placeholder.com/50x50" alt="{{ $row->invoice }}">
                                                @endif
                                            </td>  
                                         ...
                                         @role('admin')     <td>
                                                <a href="{{ route('bukti.edit', $row->id) }}" 
