...
<!-- 
                          ...
                          <tr>
                            ...
                            <td style="text-align:right; padding-top:10px;">
                              Rp. {{number_format($orders->harga_jual)}}
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td style="text-align:right; padding-top:10px;">
                              Rp. {{number_format($orders->biaya_admin)}}
                            </td>
                          </tr>
                          ...
                          <tr>
                            ...
                            <td>&nbsp;</td>
                            <td style="text-align:right; padding-top:10px;">
                              Rp. {{number_format($orders->nilai_ongkir)}}
                            </td>
                          </tr>
...
Thanks and see you on the next treatment !
        ...
        <tr>
          <td style="font-size:13px; color:#AFAFAF; text-align:center;">
            <p style="margin-bottom: -10px; color:#b7b7b7">
              <br /><br />
              &copy; 2019 HiStore Indonesia. All Right Reserved
            </p>

            <p>
              <a href="https://histore.id/privacy.html" style="color:#b7b7b7; text-decoration: none;">
                Privacy Policy
              </a>
            </p>
          </td>
        ...
        <tr>
          <td style="text-align:center;">
            <a href="https://histore.id"><img src="https://ipehapp.intek.id/dashboard/histore.png" width="90px" height="auto"  style="margin-bottom:10px" /></a>
          </td>
        </tr>
      </table>
      <!--/header-->
